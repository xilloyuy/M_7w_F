        ...
        switch SimMod.Scan_cond,
          case 'Normal',
            ...
            if sig_g && del_kappa,
              ...
              [AX,H1,H2] = plotyy(L_Detuning, G_SI_Log(:,1), L_Detuning, deltaBeta(5,:));
            ...
            if sig_g,
              ...
              hold on;
              f02     = zeros( 5, 1);
              f02(01) = plot(ExcSet.PP_Sp_Wvl, Max.G_SI_max_m(:,1),...
                'Color',    'r',...
                'LineStyle',' -',...
                'LineWidth',1.25);
            % f02(02) = plot(ExcSet.PP_Sp_Wvl, Max.G_SI_min_m(:,1),...
            %   'Color',    'b',...
            %   'LineStyle',' -',...
            %   'LineWidth',1.25);
              % 
              ...
              legend([f02(01)], ...
               {'Signal gain \theta_{rel,Max}'},...
                ...
                'Location','Northeast');  
              %%
              saveas(gcf,['sig_g_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
                          '.fig']);
              print(gcf,'-dtiff','-r300',...
                         ['sig_g_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
                          '.tif']);
            else % sig_g == 0,
              %
            ...
            if pwr_evo, 
              ...
              subplot(2,1,1);
              hold on;
              f03(01) = plot(ExcSet.PP_Sp_Wvl,Max.P_P1_max(:,1),'-b','LineWidth',1.25);% P1
              f03(02) = plot(ExcSet.PP_Sp_Wvl,Max.P_P2_max(:,1),'-g','LineWidth',1.25);% P2
              f03(03) = plot(ExcSet.PP_Sp_Wvl,Max.P_SI_max(:,1),'-k','LineWidth',1.25);% SI 
              f03(04) = plot(ExcSet.PP_Sp_Wvl,Max.P_P3_max(:,1),'-y','LineWidth',1.25);% P3 
              f03(05) = plot(ExcSet.PP_Sp_Wvl,Max.P_P4_max(:,1),'-r','LineWidth',1.25);% P4
              f03(06) = plot(ExcSet.PP_Sp_Wvl,Max.P_S1_max(:,1),'-m','LineWidth',1.25);% S1
              f03(07) = plot(ExcSet.PP_Sp_Wvl,Max.P_S2_max(:,1),'-c','LineWidth',1.25);% S2
              ...
              subplot(2,1,2);
              hold on;
              f03(08) = plot(ExcSet.PP_Sp_Wvl,Raw.P_P1_Log(:,1),'-b','LineWidth',1.25);% P1
              f03(09) = plot(ExcSet.PP_Sp_Wvl,Raw.P_P2_Log(:,1),'-g','LineWidth',1.25);% P2
              f03(10) = plot(ExcSet.PP_Sp_Wvl,Raw.P_SI_Log(:,1),'-k','LineWidth',1.25);% SI
              f03(11) = plot(ExcSet.PP_Sp_Wvl,Raw.P_P3_Log(:,1),'-y','LineWidth',1.25);% P3
              f03(12) = plot(ExcSet.PP_Sp_Wvl,Raw.P_P4_Log(:,1),'-r','LineWidth',1.25);% P4
              f03(13) = plot(ExcSet.PP_Sp_Wvl,Raw.P_S1_Log(:,1),'-m','LineWidth',1.25);% S1
              f03(14) = plot(ExcSet.PP_Sp_Wvl,Raw.P_S2_Log(:,1),'-c','LineWidth',1.25);% S2
        ...
        switch SimMod.Scan_cond,
          case 'Normal',
            ...
            if sig_g,
              ...
              f01     = zeros( 1, 1);
              f01(01) = plot(ExcSet.PP_Sp_Wvl, Max.G_SI_max_m(:,1),...
                'Color',    'r',...
                'LineStyle',' -',...
                'LineWidth',1.25);
              f01(02) = plot(ExcSet.PP_Sp_Wvl, Max.G_SI_zro_m(:,1),...
                'Color',    'b',...
                'LineStyle','--',...
                'LineWidth',1.25);
              set(gca,'xLim', [  0, (SimMod.Freq_rang/125e9)],...
...
%                     'xTick',(  0.0: ceil(rPL(end,1))/5 : ceil(rPL(end,1))),...
            ...
            % 'GER  \delta\lambda_{OFS}=-0.6nm';'GER  \delta\lambda_{OFS}=0.15nm';'GER  \delta\lambda_{OFS}=1.0nm'  
              %%
              saveas(gcf,['NPS_7w_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
                          '_PP=',       num2str(ExcSet.PP_Sp_Wvl,    '%3.1f'),...
                          '.fig']);
              print(gcf,'-dtiff','-r300',...
                         ['NPS_7w_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
                          '_PP=',       num2str(ExcSet.PP_Sp_Wvl,    '%3.1f'),...
                          '.tif']);
            else % sig_g_NPS == 0,
              % 
            ...
            % rPL(:,1)= NLM.Gamma*2*Exc.Pwr(:,1)*NLM.Len/pi; % rPL = NPS
              ...
              legend([f01(01),f01(02),f01(03),f01(04),f01(05),f01(06)], ...
               {['\Delta\lambda_{PPD}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
                ['\Delta\lambda_{PPD}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
                ['\Delta\lambda_{PPD}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
                ['\Delta\lambda_{PPD}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
                ['\Delta\lambda_{PPD}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
...
%            {['\Delta\lambda_{PP}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
%             ['\Delta\lambda_{PP}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
%             ['\Delta\lambda_{PP}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
%             ['\Delta\lambda_{PP}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
%             ['\Delta\lambda_{PP}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']; ...
...
%           saveas(gcf,['PtA_7w_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
%                       '_PP=',       num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),...
%                       '.fig']);
%           print(gcf,'-dtiff','-r300',...
%                      ['PtA_7w_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
%                       '_PP=',       num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),...
%                       '.tif']);
        else % PtA_TC == 0
          % not defined
...
%             'Location','Best');
          ...
          legend([f03( 1)], ...
           {['\Delta\lambda_{PP}=',num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),'nm']},...
            ...
            'Location','Best');
          %%
%           saveas(gcf,['PtP_7w_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
%                       '_PP=',       num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),...
%                       '.fig']);
%           print(gcf,'-dtiff','-r300',...
%                      ['PtP_7w_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
%                       '_PP=',       num2str(ExcSet.PP_Sp_Wvl(01),'%3.1f'),...
%                       '.tif']);
        else % PtP_TC  == 0
          % not defined
      ...
      case 'Propagation_Z',  
        ...
        if pwr_evo,
          ...
          legend([f02(01),f02(02),f02(03),f02(04),f02(05),f02(06),f02(07)], ...
            ...
            'Location','Best');
          %%
        % saveas(gcf,['PropZ_Pevo_7w_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
        %             '_PP=',              num2str(ExcSet.PP_Sp_Wvl,    '%3.1f'),...
        %             '.fig']);
        % print(gcf,'-dtiff','-r300',...
        %            ['PropZ_Pevo_7w_OFS=',num2str(SimMod.Wvlen_ofs*1e9,'%3.1f'),...
        %             '_PP=',              num2str(ExcSet.PP_Sp_Wvl,    '%3.1f'),...
        %             '.tif']);
...
%                 'Location','Northeast'); 
          ...
          case 'Propagate',   
            ...
            % PCS.rPL(:,1)= NLM.Gamma*2*Exc.Pwr(:,1)*ExcSet.PropZ_Len/pi; % NPS, rPL 
              ...
              f02(01) = plot(ExcSet.PropZ_Len./ExcSet.PropZ_Len(end),Max.P_P1_Log_max_evo(30,:),'-b','LineWidth',1.25);% P1
              f02(02) = plot(ExcSet.PropZ_Len./ExcSet.PropZ_Len(end),Max.P_P2_Log_max_evo(30,:),'-g','LineWidth',1.25);% P2
              f02(03) = plot(ExcSet.PropZ_Len./ExcSet.PropZ_Len(end),Max.P_SI_Log_max_evo(30,:),'-k','LineWidth',1.25);% SI
              f02(04) = plot(ExcSet.PropZ_Len./ExcSet.PropZ_Len(end),Max.P_P3_Log_max_evo(30,:),'-r','LineWidth',1.25);% P3
              f02(05) = plot(ExcSet.PropZ_Len./ExcSet.PropZ_Len(end),Max.P_P4_Log_max_evo(30,:),'-y','LineWidth',1.25);% P4
              f02(06) = plot(ExcSet.PropZ_Len./ExcSet.PropZ_Len(end),Max.P_S1_Log_max_evo(30,:),'-m','LineWidth',1.25);% S1
              f02(07) = plot(ExcSet.PropZ_Len./ExcSet.PropZ_Len(end),Max.P_S2_Log_max_evo(30,:),'-c','LineWidth',1.25);% S2
...
%             'FontName','Arial','FontSize',12,'FontWeight','bold','Location','Southeast');
      ...
      case 'Propagation_Z',  
        ...
        if pwr_evo,
          ...
          f02(01) = plot(ExcSet.PropZ_Len./HNLF.Len,Max.P_P1_max_z(1,:),'-b','LineWidth',1.25);% P1
          f02(02) = plot(ExcSet.PropZ_Len./HNLF.Len,Max.P_P2_max_z(1,:),'-g','LineWidth',1.25);% P2
          f02(03) = plot(ExcSet.PropZ_Len./HNLF.Len,Max.P_SI_max_z(1,:),'-k','LineWidth',1.25);% SI
          f02(04) = plot(ExcSet.PropZ_Len./HNLF.Len,Max.P_P3_max_z(1,:),'-r','LineWidth',1.25);% P3
          f02(05) = plot(ExcSet.PropZ_Len./HNLF.Len,Max.P_P4_max_z(1,:),'-y','LineWidth',1.25);% P4
          f02(06) = plot(ExcSet.PropZ_Len./HNLF.Len,Max.P_S1_max_z(1,:),'-m','LineWidth',1.25);% S1
          f02(07) = plot(ExcSet.PropZ_Len./HNLF.Len,Max.P_S2_max_z(1,:),'-c','LineWidth',1.25);% S2
