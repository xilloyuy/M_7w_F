...
fprintf(1,'Fabricating the HNLF... ');

global NLM;     % Nonlinear medium parameters

NLM    = [];    % Class of nonlinear medium parameters

NLM.SN = 04;    % Series number of NLM

% Load HNLF parameters
f_NLM( NLM.SN );   % NLM select function
                   % 00: simulation trial
                   % 04: 01+02+03, HNLF standard @ ZDW=1547.50nm
                   % 07: 05+06,    HNLF Spine @ ZDW=1566.00nm
...
switch SimMod.Scan_mode,
  case 'Cen_Wavelength', 
    ...
    for j1 = 1 : SimMod.Wlofs_num,
      ...
      ExcSet.Lambda_s = NLM.ZDW + SimMod.Wvlen_ofs(j1);
      ...
      for j2 = 1 : SimMod.WlSep_num,
        ...
        [beta_matrix(:,j2),ExcSet.PP_Sp_Wvl(j2)] = f_delta_beta(ExcSet.Lambda_s,ExcSet.Sc_PP_Frq(j2)); 
          ...
          for j4 = 1 : SimMod.Phase_num,
            ...
            for j5 = 1 : 1,
              ...
              if SimMod.FLD_nPWR == 0,
                ...
                if SimMod.PSA_nPIA == 0,
                  ...
                  options = odeset('RelTol', 1e-9, 'AbsTol', [1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 ...
                                      ...
                                      1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12]); % 
                  [z,P]   = ode45 (@dE_dz_7wave, [0 HNLF.Len], ...
                  ...
                  options = odeset('RelTol', 1e-9, 'AbsTol', [1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12]); % 
                  [z,P]   = ode45 (@dA_dz_7wave, [0 HNLF_Len], ...
                                   [A_P1 A_P2 A_SI A_P4 A_P3 A_S1 A_S2], ...
                                   options);  % Initial Conditions
                  %-------------------------------------------------------------
              ...
              %---------------------------------------------------------------------------
                ...
                [z,A]  = ode45(@dA_dz_7wave, [0 ExcSet.PropZ_Len], ...
  ...
  case 'PP_Separation',  
    ...
    for j1 = 1 : SimMod.Wlofs_num,
      ...
      ExcSet.Lambda_s = HNLF.ZDW + SimMod.Wvlen_ofs(j1);
              ...
              if SimMod.FLD_nPWR == 0,
                ...
                if SimMod.PSA_nPIA == 0,
                  ...
                  options = odeset('RelTol', 1e-6, 'AbsTol', [1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 ...
                                      1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 ...
                                      1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12]); % 
                  [z,P]   = ode45 (@dE_dz_7wave, [0 HNLF_Len], ...
                                   [A_P1 A_P2 A_SI A_P4 A_P3 A_S1 A_S2 ...
                                   Theta( 1) Theta( 2) Theta( 3) Theta( 4) Theta( 5) Theta( 6) ...
                                   Theta( 7) Theta( 8) Theta( 9) Theta(10) Theta(11) Theta(12) ...
                                   Theta(13) Theta(14) Theta(15) Theta(16) Theta(17) Theta(18) ...
  ...
  case 'Pump_Power',     
    ...
    for j1 = 1 : SimMod.Wlofs_num,
      ...
      for j2 = 1 : SimMod.WlSep_num,
        ...
        % Calculate beta_vector and delta_beta(22,1) by Freq detuning
       [beta_matrix(:,j2),ExcSet.Dl_PPS_wl(j2)] = f_delta_beta(ExcSet.Lambda_s,ExcSet.Sc_PPS_fq(j2)); 
        ExcSet.Dl_PPS_wl(j2) = ExcSet.Dl_PPS_wl(j2)*2e9; 
        d_kappa_Lin(:,j2)    = delta_beta; 
              ...
              case 'Propagate', 
                ...
                for j5 = 1 : 1,
                  ...
                  %-------------------------------------------------------------
                    ...
                    option = odeset('RelTol',1e-9, 'AbsTol',[1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12]); % 
                    [z,A]  = ode45 (@dA_dz_7wave, ExcSet.PropZ_Len, ...
                                    [Exc.Fld(1,1) Exc.Fld(1,2) Exc.Fld(1,3) Exc.Fld(1,4)...
                                     Exc.Fld(1,5) Exc.Fld(1,6) Exc.Fld(1,7)],...
                                    option); % Initial Conditions
                    ...
                    Raw.F_P1_Lin(j4,:) =       A(:, 1); % V, A1 field linear
                    Raw.F_P2_Lin(j4,:) =       A(:, 2); % V, A2 field linear
                    Raw.F_SI_Lin(j4,:) =       A(:, 3); % V, A0 field linear
                    Raw.F_P3_Lin(j4,:) =       A(:, 4); 
                    Raw.F_P4_Lin(j4,:) =       A(:, 5);
                    Raw.F_S1_Lin(j4,:) =       A(:, 6);
                    Raw.F_S2_Lin(j4,:) =       A(:, 7);

                    Raw.P_P1_Lin(j4,:) =  (abs(A(:, 1))).^2; % W, A1 power lin
                    Raw.P_P2_Lin(j4,:) =  (abs(A(:, 2))).^2; % W, A2 power lin
                    Raw.P_SI_Lin(j4,:) =  (abs(A(:, 3))).^2; 
                    Raw.P_P3_Lin(j4,:) =  (abs(A(:, 4))).^2;
                    Raw.P_P4_Lin(j4,:) =  (abs(A(:, 5))).^2;
                    Raw.P_S1_Lin(j4,:) =  (abs(A(:, 6))).^2;
                    Raw.P_S2_Lin(j4,:) =  (abs(A(:, 7))).^2;

                    Raw.Phase_P1(j4,:) = angle(A(:,1));  % rad, A1 phase lin
                    Raw.Phase_P2(j4,:) = angle(A(:,2));  % rad, A2 phase lin
                    Raw.Phase_SI(j4,:) = angle(A(:,3));  % rad, A0 phase lin
                    Raw.Phase_P3(j4,:) = angle(A(:,4));  % rad,
                    Raw.Phase_P4(j4,:) = angle(A(:,5));  % rad,
                    Raw.Phase_S1(j4,:) = angle(A(:,6));  % rad,
                    Raw.Phase_S2(j4,:) = angle(A(:,7));  % rad,
              ...
              case 'Len_Z_var', 
                ...
                for j5 = 2 : SimMod.PropZ_num,
                  ...
                  %---------------------------------------------------------------------------
                    ...
                    option = odeset('RelTol',1e-9, 'AbsTol',[1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12]); % 
                    [z,A]  = ode45 (@dA_dz_7wave, [0 ExcSet.PropZ_Len(j5)], ...
                                    [Exc.Fld(1,1) Exc.Fld(1,2) Exc.Fld(1,3) Exc.Fld(1,4)...
                                     Exc.Fld(1,5) Exc.Fld(1,6) Exc.Fld(1,7)],...
                                    option); % Initial Conditions
  ...
  case 'Signal_Power',   
    ...
    for j1 = 1 : SimMod.Wlofs_num,
      ...
      for j2 = 1 : SimMod.WlSep_num,
        ...
        % Calculate beta_vector and delta_beta(22,1) by Freq detuning
       [beta_matrix(:,j2),ExcSet.Dl_PPS_wl(j2)] = f_delta_beta(ExcSet.Lambda_s,ExcSet.Sc_PPS_fq(j2)); 
        ExcSet.Dl_PPS_wl(j2) = ExcSet.Dl_PPS_wl(j2)*2e9; % Transfer SI to nm
        d_kappa_Lin(:,j2)    = delta_beta;  
          ...
          for j4 = 1 : SimMod.Phase_num,
            ...
            for j5 = 1 : 1,
              ...
              %---------------------------------------------------------------------------
                ...
                option = odeset('RelTol',1e-9, 'AbsTol',[1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12]); % 
                [z,A]  = ode45(@dA_dz_7wave, [0 HNLF.Len], ...
                               [Exc.Fld(1,1) Exc.Fld(1,2) Exc.Fld(1,3) Exc.Fld(1,4)...
                                Exc.Fld(1,5) Exc.Fld(1,6) Exc.Fld(1,7)],...
                               option); % Initial Conditions
              ...
              case 'Propagate', 
                ...
                for j5 = 1 : 1,
                  ...
                  %-------------------------------------------------------------
                    ...
                    option = odeset('RelTol',1e-9, 'AbsTol',[1e-12 1e-12 1e-12 1e-12 1e-12 1e-12 1e-12]); % 
                    [z,A]  = ode45 (@dA_dz_7w, ExcSet.PropZ_Len, ...
                                    [Exc.Fld(1,1) Exc.Fld(1,2) Exc.Fld(1,3) Exc.Fld(1,4)...
                                     Exc.Fld(1,5) Exc.Fld(1,6) Exc.Fld(1,7)],...
                                    option); % Initial Conditions
                    ...
                    Raw.P_P1_Lin(j4,:) =  (abs(A(:, 1))).^2;
                    Raw.P_P2_Lin(j4,:) =  (abs(A(:, 2))).^2;
                    Raw.P_SI_Lin(j4,:) =  (abs(A(:, 3))).^2;
                    Raw.P_P3_Lin(j4,:) =  (abs(A(:, 4))).^2;
                    Raw.P_P4_Lin(j4,:) =  (abs(A(:, 5))).^2;
                    Raw.P_S1_Lin(j4,:) =  (abs(A(:, 6))).^2;
                    ...
                    Raw.Phase_P1(j4,:) = angle(A(:,1));                   % rad,
                    Raw.Phase_P2(j4,:) = angle(A(:,2));                   % rad,
                    Raw.Phase_SI(j4,:) = angle(A(:,3));                   % rad,
                    Raw.Phase_P3(j4,:) = angle(A(:,4));                   % rad,
                    Raw.Phase_P4(j4,:) = angle(A(:,5));                   % rad,
                    Raw.Phase_S1(j4,:) = angle(A(:,6));                   % rad,
                    Raw.Phase_S2(j4,:) = angle(A(:,7));                   % rad,
  ...
  case 'Constellation',  
    ...
    for j1 = 1 : SimMod.Wlofs_num,
      ...
      for j2 = 1 : SimMod.WlSep_num,
        ...
        % Calculate beta_vector and delta_beta(22,1) by Freq detuning
        [beta_matrix(:,j2),ExcSet.Sc_PPS_wl(j2)] = f_delta_beta(ExcSet.Lambda_s,ExcSet.Sc_PPS_fq(j2)); 
...
f_Visualization( ...
  0, ...% sig_g,    Fig.01 Signal gain vs. PP_Separation
  1, ...% pwr_evo,  Fig.02 Power evolution vs. PP_Separation
  0, ...% kappa,    Fig.03 Total phase mismatch vs. PP_Separation
  1, ...% sig_g_NPS,Fig.01 Signal gain vs. nonlineariy phase shift (rPL)
  0, ...% PSER_PSGA,Fig.06 Signal gain vs. Nonlineariy phase shift (rPL)
  0, ...% PtA_TC,   Fig.05 Phase-to-amplitude transfer function
  0, ...% PtP_TC,   Fig.07 Phase-to-phase transfer function
  0  ...% PtT_TC_c, Fig.08 Complex output signal trajectory vs. Input signal phase
  );
%-------------------------------------------------------------------------------
